...
if __name__ == "__main__":
    save_file("movie", "backend/data/raw/movies.json", "backend/data/raw/movies_cleaned.json")
    save_file("tv", "backend/data/raw/tv.json", "backend/data/raw/tv_cleaned.json")